...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    //     header("Location: staffSignup.php?error=empty_fields");
    //     exit();}
    if(($password==$cpassword) && $exists==false)
    {
        $sql="INSERT INTO `staff` (`username`, `password`, `dt`) VALUES ('$username', '$password', current_timestamp())";
...
?>
    ...
    <div id="studentSignUp" class="login-form">
        ...
        <p>Already have an account? <a href="/staffLogin.html">Login</a></p>
    </div>
